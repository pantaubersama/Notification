...
set :sneakers_workers, ["Subscribers::JanjiPolitik", "Subscribers::Pilpres", "Subscribers::Profile", "Subscribers::Question", "Subscribers::Quiz", "Subscribers::Badge", "Subscribers::WordStadiumChallenge", "Subscribers::WordStadiumInfo"]
# WORKERS=Subscribers::WordStadium rake sneakers:run
