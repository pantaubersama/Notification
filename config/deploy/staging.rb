...
set :sneakers_workers, ["Subscribers::JanjiPolitik", "Subscribers::Pilpres", "Subscribers::Profile", "Subscribers::Question", "Subscribers::Quiz", "Subscribers::Badge", "Subscribers::WordStadium"]
